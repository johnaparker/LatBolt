...
outFile = h5py.File('temp.h5', 'w')

dset = outFile.create_dataset("rho", (NX, NY, 0), maxshape=(NX,NY,None), chunks=(NX, NY, 1))
dset = outFile.create_dataset("Ux", (NX, NY, 0),  maxshape=(NX,NY,None), chunks=(NX, NY, 1))
dset = outFile.create_dataset("Uy", (NX, NY, 0),  maxshape=(NX,NY,None), chunks=(NX, NY, 1))
dset = outFile.create_dataset("P", (NX, NY, 0),   maxshape=(NX,NY,None), chunks=(NX, NY, 1))
